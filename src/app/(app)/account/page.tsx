...
export default function AccountRoute() {
  ...
  const { user, loading, error, updateUser, signOut, changePassword } = useUser();
  ...
  useEffect(() => {
    if (!user?.id) return;
    void loadPoints();
    const intervalId = window.setInterval(() => { void loadPoints(); }, 10000);
    const handleActivityChanged = () => { void loadPoints(); };
    const handleFocus = () => { void loadPoints(); };
    window.addEventListener("trasmart:activity-changed", handleActivityChanged);
    window.addEventListener("focus", handleFocus);
    return () => {
      window.clearInterval(intervalId);
      window.removeEventListener("trasmart:activity-changed", handleActivityChanged);
      ...
      <div className={styles.contentWrapper}>
        <div className={styles.profileCard}>
          <div className={styles.profileHeader}>
            ...
            <div className={styles.profileBasic}>
              <h1 className={styles.profileName}>{user?.fullName || "Guest"}</h1>
              {user?.username && (
              ...
              <>
                ...
                <div className={styles.detailItem}>
                  ...
                  <div className={styles.detailContent}>
                    ...
                    <small style={{ color: "#999" }}>Email cannot be changed here</small>
                  </div>
                </div>
                <div className={styles.detailItem}>
              ...
              <>
                <div className={styles.formGroup}>
                  ...
                  <input id="username" name="username" type="text" className={styles.input}
                    value={formData.username || ""} onChange={handleInputChange} disabled={isSaving} />
                </div>
                <div className={styles.formGroup}>
                  ...
                  <input id="fullName" name="fullName" type="text" className={styles.input}
                    value={formData.fullName || ""} onChange={handleInputChange} disabled={isSaving} />
                </div>
                <div className={styles.formGroup}>
                ...
                <div className={styles.formGroup}>
                  ...
                  <input id="phone" name="phone" type="tel" className={styles.input}
                    value={formData.phone || ""} onChange={handleInputChange} disabled={isSaving} />
                </div>
                <div className={styles.formGroup}>
                  <label htmlFor="address" className={styles.label}>Alamat</label>
                  <input id="address" name="address" type="text" className={styles.input}
                    value={formData.address || ""} onChange={handleInputChange} disabled={isSaving} />
                </div>
                <div className={styles.formGroup}>
                  <label htmlFor="city" className={styles.label}>Kota</label>
                  <input id="city" name="city" type="text" className={styles.input}
                    value={formData.city || ""} onChange={handleInputChange} disabled={isSaving} />
                </div>
                <div className={styles.formGroup}>
                  <label htmlFor="postal_code" className={styles.label}>Kode Pos</label>
                  <input id="postal_code" name="postal_code" type="text" className={styles.input}
                    value={formData.postal_code || ""} onChange={handleInputChange} disabled={isSaving} />
                </div>
        ...
        <div className={styles.sidebar}>
          ...
          <div className={styles.actionsCard}>
            ...
            <button className={styles.actionBtn} onClick={handleOpenPasswordModal}>
              Ubah Password
            </button>
      ...
      {isPasswordModalOpen && (
        ...
        >
          <div className={styles.modalCard} onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={(e) => { e.preventDefault(); void handlePasswordChange(); }}>
              {/* Password Saat Ini */}
              <div className={styles.formGroup}>
                ...
                <div className={styles.passwordInputWrapper}>
                  <span className={styles.passwordIconLeft}><Lock size={16} /></span>
                  <input
                    id="currentPassword"
                  ...
                  />
                  <button type="button" className={styles.passwordToggleBtn}
              ...
              {passwordError && (
                <div className={styles.errorMessage} role="alert">{passwordError}</div>
              )}
              {passwordSuccess && (
                <div className={styles.successMessage} role="status">{passwordSuccess}</div>
              )}
              ...
              <div className={styles.formActions}>
                ...
                <button type="button" className={styles.cancelBtn}
                  onClick={handleClosePasswordModal} disabled={isChangingPassword}>
                  <X size={18} />
                  Batal
                </button>
              </div>
